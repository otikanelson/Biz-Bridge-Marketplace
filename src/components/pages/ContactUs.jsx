        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Customer Support: +234 123 456 7890<br />
                        Artisan Support: +234 123 456 7891<br />
                        General Inquiries: +234 123 456 7892
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Customer Support: support@bizbridge.com<br />
                        Artisan Support: artisans@bizbridge.com<br />
                        Business Inquiries: info@bizbridge.com
                      </p>
                    </div>
                  </div>
              ...
              <div>
                ...
                {submitSuccess ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className={`w-full bg-red-500 text-white py-3 px-4 rounded hover:bg-red-600 transition ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
            ...
            <div className="mt-16">
              ...
              <div className="border-4 border-red-400 h-96 rounded-lg flex items-center justify-center bg-gray-100">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm mt-2">Integration with Google Maps or other mapping service</p>
                </div>
              </div>
            </div>
          </div>
